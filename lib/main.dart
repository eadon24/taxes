...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 12.65; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      50.85; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 42.71; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 02/11/2024';

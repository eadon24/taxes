...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 51.20, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {
      'pais': 'Chile',
      'tasa': 175.000,
      'modo': 'multiplicar',
    ...
    {'pais': 'EE.UU.', 'tasa': 173.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 135.6399;
  int selectedIndex = 0;
  String updateText = 'Actualización 16-08-2025';

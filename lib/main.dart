...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 20.60; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      81.14; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 63.49; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 25/02/2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 25.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      100.86; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 78.59; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 15/04/2025';

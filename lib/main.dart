...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 12.10; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      47.85; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 39.18; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 22/10/2024';

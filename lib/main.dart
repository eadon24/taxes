...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    ...
    {'pais': 'Chile', 'tasa': 0.540, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
    {'pais': 'Colombia', 'tasa': 8.00, 'modo': 'dividir', 'bandera': '🇨🇴'},
    {'pais': 'EE.UU.', 'tasa': 500.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 330.3751;
  int selectedIndex = 0;
  String updateText = 'Actualización 13-01-2025';

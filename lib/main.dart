...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.35; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      56.84; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 48.79; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 07/12/2024';

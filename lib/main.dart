        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 17/09/2024 2:00pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.68; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      42.75; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización 17/09/2024 2:00 pm';

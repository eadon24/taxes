...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 34.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      133.15; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 95.08; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 24-05-2025';

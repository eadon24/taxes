...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.70; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      58.00; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 49.11; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 11/12/2024';

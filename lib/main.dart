...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 16.65; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      65.69; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 51.93; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 30/12/2024';

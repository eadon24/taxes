...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 15.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      60.17; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 50.37; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 17/12/2024';

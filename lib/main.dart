...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 11.85; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      46.30; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 37.07; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 09/10/2024';

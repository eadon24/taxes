...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 12.54; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      51.18; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización 01/11/2024';

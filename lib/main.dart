...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 30.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      118.75; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 94.16; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 15-05-2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 15.65; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      61.85; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 50.54; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 18/12/2024';

        ...
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización: 30/07/2024 VENEZUELA LIBRE',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.30; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      42.35; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.61; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización: 30/07/2024 VENEZUELA LIBRE';

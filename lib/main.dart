...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 12.40; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      48.87; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 39.32; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 23/10/2024';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 134.00, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {'pais': 'Chile', 'tasa': 0.455, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
    {'pais': 'Colombia', 'tasa': 9.00, 'modo': 'dividir', 'bandera': '🇨🇴'},
    {'pais': 'EE.UU.', 'tasa': 410.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 282.5128;
  int selectedIndex = 0;
  String updateText = 'Actualización 19-12-2025';

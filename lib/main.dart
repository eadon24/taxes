...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 18.50; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      73.46; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 60.54; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 11/02/2025';

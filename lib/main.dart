...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      52.54; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 44.75; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 12/11/2024';

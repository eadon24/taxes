        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 07/04/2025 2:00pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 24.50; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      97.75; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 72.19; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 07/04/2025 2:00pm';

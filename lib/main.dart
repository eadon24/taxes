        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 11/04/2025 2:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 25.45; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      101.09; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 77.26; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 11/04/2025 2:00 pm';

        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 02/10/2024 2:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      44.65; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.92; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 02/10/2024 2:00 pm';

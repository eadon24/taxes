        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 30/10/2024 2:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 13.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      52.30; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 42.23; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 30/10/2024 2:00 pm';

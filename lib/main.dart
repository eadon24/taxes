...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 206.00, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {'pais': 'Chile', 'tasa': 0.770, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
    /*{'pais': 'Colombia', 'tasa': 6.80, 'modo': 'dividir', 'bandera': '🇨🇴'},*/
    {'pais': 'EE.UU.', 'tasa': 690.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 560.3753;
  int selectedIndex = 0;

  String updateText = 'Actualización 04-06-2026';

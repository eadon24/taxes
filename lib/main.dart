...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.60; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      57.86; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 48.12; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 05/12/2024';

        ...
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización: 07/08/2024 01:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.45; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      41.65; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.66; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización: 07/08/2024 01:00 pm';

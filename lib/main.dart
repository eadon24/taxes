...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.00; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      56.59; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización 30/11/2024';

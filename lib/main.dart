...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 18.90; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      75.46; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 61.03; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 12/02/2025';

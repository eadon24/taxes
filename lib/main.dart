        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 19/09/2024 12:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 11.15; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      44.17; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.78; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 19/09/2024 12:00 pm';

        ...
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización: 28/07/2024 VENEZUELA LIBRE',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.50; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      42.50; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.58; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización: 28/07/2024 VENEZUELA LIBRE';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 35.70; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      138.98; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 96.53; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 29-05-2025';

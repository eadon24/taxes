...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      52.22; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 44.19; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 08/11/2024';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      80.18; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 62.18; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 19/02/2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 25.40; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      101.66; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 70.25; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 03/04/2025';

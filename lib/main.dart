...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 100.00, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {'pais': 'Chile', 'tasa': 0.350, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
    {'pais': 'Colombia', 'tasa': 11.00, 'modo': 'dividir', 'bandera': '🇨🇴'},
    {'pais': 'EE.UU.', 'tasa': 330.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 243.11;
  int selectedIndex = 0;
  String updateText = 'Actualización 25-11-2025';

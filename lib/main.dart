...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 16.60; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      65.65; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 56.65; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 27/01/2025';

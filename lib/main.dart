        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 07/10/2024 12:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 11.35; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      45.09; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 37.04; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 07/10/2024 12:00 pm';

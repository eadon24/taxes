...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      47.73; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 37.53; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 11/10/2024';

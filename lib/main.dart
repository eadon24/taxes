...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.05; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      55.96; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 47.31; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 02/12/2024';

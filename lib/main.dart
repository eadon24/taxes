...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 52.50, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {
      'pais': 'Chile',
      'tasa': 185.000,
      'modo': 'multiplicar',
    ...
    {'pais': 'Colombia', 'tasa': 22.00, 'modo': 'dividir', 'bandera': '🇨🇴'},
    {'pais': 'EE.UU.', 'tasa': 178.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 136.89;
  int selectedIndex = 0;
  String updateText = 'Actualización 19-08-2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      114.71; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 88.72; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 06-05-2025';

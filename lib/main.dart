...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 25.35; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      100.37; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 80.96; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización Jueves Santo';

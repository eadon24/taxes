        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 21/11/2024 12:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.10; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      56.82; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 46.06; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 21/11/2024 12:00 pm';

        ...
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 09/09/2024 10:30 am',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.72; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      42.65; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.64; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 09/09/2024 10:30 am';

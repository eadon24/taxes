...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 20.70; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      80.12; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 66.44; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 15/03/2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 21.00; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      82.30; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 64.02; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 26/02/2025';

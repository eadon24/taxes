        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 20/09/2024 12:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 11.10; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      43.90; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 36.80; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 20/09/2024 12:00 pm';

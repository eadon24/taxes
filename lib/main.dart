...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 19.80; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      78.05; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 65.27; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 10/03/2025';

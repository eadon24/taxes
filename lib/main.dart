...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 27.65; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      108.90; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 86.85; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 01-05-2025';

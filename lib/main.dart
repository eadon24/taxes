        ...
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización: 05/08/2024 02:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 10.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      41.60; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización: 05/08/2024 02:00 pm';

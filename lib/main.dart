...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 37.00; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      142.42; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 95.24; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 27-05-2025';

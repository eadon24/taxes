...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 33.40; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      131.46; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 94.86; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 21-05-2025';

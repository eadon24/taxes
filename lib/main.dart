...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 13.40; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      53.47; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 45.05; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 16/11/2024';

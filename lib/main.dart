        ...
        body: Container(
          ...
          child: const Center(
            child: Column(
              ...
              children: [
                Text(
                  'Actualización 21/10/2024 2:00 pm',
...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 12.00; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      47.35; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 39.17; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 21/10/2024 2:00 pm';

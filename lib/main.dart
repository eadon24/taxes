...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 34.40; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      134.24; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 95.02; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 23-05-2025';

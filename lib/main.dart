...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 16.25; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      66.25; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización 31/12/2024';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 40.30; // Tasa de cambio soles a bolívares
  double dollarBCVRate = 119.14; // Tasa de cambio bolívares a dólares BCV
  String updateText = 'Actualización 19-07-2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 14.80; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      58.57; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 50.33; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 16/12/2024';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 195.00, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {'pais': 'Chile', 'tasa': 0.725, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
    /*{'pais': 'Colombia', 'tasa': 6.80, 'modo': 'dividir', 'bandera': '🇨🇴'},*/
    {'pais': 'EE.UU.', 'tasa': 655.0, 'modo': 'multiplicar', 'bandera': '🇺🇸'},
  ];

  double dollarBCVRate = 526.8694;
  int selectedIndex = 0;

  String updateText = 'Actualización 22-05-2026';

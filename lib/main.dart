...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 13.35; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      53.20; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 44.93; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 13/11/2024';

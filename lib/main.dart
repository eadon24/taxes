...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 29.50; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      115.97; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 92.83; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 09-05-2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 20.80; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      81.40; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 64.24; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 27/02/2025';

...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double dollarParallelRate =
      133.29; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 94.97; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 22-05-2025';

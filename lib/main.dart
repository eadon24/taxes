...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 24.20; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      96.48; // Tasa de cambio bolívares a dólares paralelo
  ...
  String updateText = 'Actualización 07/04/2025';

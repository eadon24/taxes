...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  final List<Map<String, dynamic>> tasasPorPais = [
    {'pais': 'Perú', 'tasa': 171.00, 'modo': 'multiplicar', 'bandera': '🇵🇪'},
    {'pais': 'Chile', 'tasa': 0.630, 'modo': 'multiplicar', 'bandera': '🇨🇱'},
  ...
  int selectedIndex = 0;
  String updateText = 'Actualización 04-04-2026';

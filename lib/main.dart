...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 34.15; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      135.75; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 96.86; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualiza
  //r la fecha y hora
  String updateText = 'Actualización 30-05-2025';

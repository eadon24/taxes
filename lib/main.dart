...
class _ExchangeCalculatorState extends State<ExchangeCalculator> {
  ...
  double exchangeRate = 22.80; // Tasa de cambio soles a bolívares
  double dollarParallelRate =
      88.09; // Tasa de cambio bolívares a dólares paralelo
  double dollarBCVRate = 68.31; // Tasa de cambio bolívares a dólares BCV

  // Variable que debes modificar para actualizar la fecha y hora
  String updateText = 'Actualización 22/03/2025';
